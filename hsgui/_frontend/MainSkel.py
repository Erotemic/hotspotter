...
# Form implementation generated from reading ui file 'C:\Users\jon.crall\code\hotspotter\hsgui/_frontend\MainSkel.ui'
#
...
class Ui_mainSkel(object):
    ...
    def retranslateUi(self, mainSkel):
        ...
        self.tablesTabWidget.setTabText(self.tablesTabWidget.indexOf(self.name_view), _translate("mainSkel", "Name View", None))
