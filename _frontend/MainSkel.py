...
class Ui_mainSkel(object):
    ...
    def retranslateUi(self, mainSkel):
        ...
        self.actionDelete_computed_directory.setText(_translate("mainSkel", "Delete Computed Dir", None))
        self.actionDelete_global_preferences.setText(_translate("mainSkel", "Delete Global Prefs", None))
        ...
        self.actionDev_Mode_IPython.setText(_translate("mainSkel", "Dev Mode (IPython)", None))
