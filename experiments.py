...
def vsmany_experiment():
    pass

def vsone_experiment():
    pass

def bagofwords_experiment():
    pass

def sonograms_experiment():
    import load_data2
    import match_chips2 as mc2
    import params
    params.__MATCH_TYPE__ = 'vsmany'
    params.__VSMANY_K__ = 5
    print params.param_string()
    algo_uid = params.get_algo_uid()
    load_data2.reload_module()
    db_dir = load_data2.SONOGRAMS
