...
python investigate_chip.py --dbG --tests test-cfg-vsmany-3 --sthresh 10 80 --printoff --nocache-query
python investigate_chip.py --dbG --tests test-cfg-vsmany-3 --sthresh  0 80 --printoff --nocache-query 
python investigate_chip.py --dbG --tests test-cfg-vsmany-3 --sthresh  0 100 --printoff --nocache-query 
python investigate_chip.py --dbG --tests test-cfg-vsmany-3 --sthresh  0 9001 --printoff --nocache-query 
