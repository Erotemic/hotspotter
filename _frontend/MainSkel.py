...
# Form implementation generated from reading ui file '/home/joncrall/code/hotspotter/frontend/MainSkel.ui'
#
...
class Ui_mainSkel(object):
    ...
    def retranslateUi(self, mainSkel):
        ...
        self.menuView.setTitle(QtGui.QApplication.translate("mainSkel", "Convenience", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.menuExperiments.setTitle(QtGui.QApplication.translate("mainSkel", "Experiments", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionReselect_Orientation.setText(QtGui.QApplication.translate("mainSkel", "Reselect Orientation", None, QtGui.QApplication.UnicodeUTF8))
        self.actionReselect_Orientation.setShortcut(QtGui.QApplication.translate("mainSkel", "O", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAdd_Metadata_Property.setText(QtGui.QApplication.translate("mainSkel", "Add Metadata Property", None, QtGui.QApplication.UnicodeUTF8))
        self.actionAssign_Matches_Above_Threshold.setText(QtGui.QApplication.translate("mainSkel", "Assign Matches Above Threshold", None, QtGui.QApplication.UnicodeUTF8))
        self.actionMatching_Experiment.setText(QtGui.QApplication.translate("mainSkel", "Matching Experiment", None, QtGui.QApplication.UnicodeUTF8))
        self.actionName_Consistency_Experiment.setText(QtGui.QApplication.translate("mainSkel", "Run Name Consistency Experiment", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionView_Documentation.setText(QtGui.QApplication.translate("mainSkel", "View Documentation", None, QtGui.QApplication.UnicodeUTF8))
