...
print('---------------------------------------')
print('Begining spatial verification tests')
...
def __test_homog(func_homog, testname, fignum):
    ...
    return ((H12, inliers12), (H21, inliers21))
...
def __test_warp(homog_tup, testname, fignum):
    ...
    df2.imshow(rchip1_H1, fignum=fignum+1, title=testname+' warped querychip1')
    df2.imshow(rchip2_H1, fignum=fignum+0, title=testname+' warped reschip2')
    df2.imshow(rchip1_H2, fignum=fignum+3, title=testname+' warped querychip1')
    df2.imshow(rchip2_H2, fignum=fignum+2, title=testname+' warped reschip2')
