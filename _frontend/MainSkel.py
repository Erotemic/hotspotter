...
class Ui_mainSkel(object):
    def setupUi(self, mainSkel):
        ...
        self.verticalLayout_2.addWidget(self.image_TBL)
        ...
        sizePolicy.setHeightForWidth(self.chip_TBL.sizePolicy().hasHeightForWidth())
        self.chip_TBL.setSizePolicy(sizePolicy)
